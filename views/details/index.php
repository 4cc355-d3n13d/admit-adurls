...
$this->title = Yii::t('adurls', 'DETAIL_SHORT_CODE') . $url->short_code;
$this->params['breadcrumbs'][] = $this->title;
?>

<h1><?= Html::encode(Yii::t('adurls', 'DETAIL_SHORT_CODE') . Url::base(true) . Url::to(['url/forward', 'code' => $url->short_code])) ?></h1>
<div class="row">
  <div class="col-md-12">
    <?php
...
<div class="row">
  <div class="col-md-6">
    ...
    echo GoogleChart::widget(array('visualization' => 'PieChart',
      ...
      'options' => [
        'title' => Yii::t('adurls', 'USER_PLATFORM'),
        'is3D' => true,
      ]));
    ?>
  </div>
  ...
  <div class="col-md-12">
    <table cellspacing="0" class="table table-hover">
      ...
      <tr class="text-uppercase">
        <th><?= Yii::t('adurls', 'REFER_URL') ?></th>
        <th class="text-center"><?= Yii::t('adurls', 'REFER_COUNT') ?></th>
      </tr>
      </thead>
      <tbody>
      ...
      <?php else: ?>
        <tr>
          <td colspan="2">
            <?= Yii::t('adurls', 'EMPTY_ANALYTIC_REFERS') ?>
          </td>
        </tr>
      <?php endif; ?>
      </tbody>
